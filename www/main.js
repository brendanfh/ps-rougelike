...
(function(exports) {
  ...
  var move = function (d) {
      return function (v) {
          ...
          $7.pos = Data_Semiring.add(Util.semiringPoint)(v.pos)(d);
          return $7;
      };
  };
...
(function(exports) {
  ...
  var processEvents = function (gameRef) {
          ...
          return function (v1) {
              if (v1 instanceof KeyDown) {
                  var dx = (function () {
                      ...
                      return Data_Semiring.zero(Util.semiringPoint);
                  })();
                  return function __do() {
                      Control_Monad_Eff_Ref.modifyRef(v)(function (g) {
                          var $30 = {};
                          for (var $31 in g) {
                              if ({}.hasOwnProperty.call(g, $31)) {
                                  $30[$31] = g[$31];
                              };
                          };
                          $30.player = Player.move(dx)(g.player);
                          return $30;
                      })();
                      return true;
                  };
      ...
      return function __do() {
          ...
          Control_Monad_Eff_Ref.modifyRef(gameRef)(function (v2) {
              ...
              $36.eventQueue = Data_List_Types.Nil.value;
              return $36;
          })();
          return redraw;
      };
  ...
  var getCanvas = function (name) {
      return function __do() {
          ...
          return __unused()((function () {
              ...
              throw new Error("Failed pattern match at Main line 43, column 5 - line 43, column 45: " + [ v.constructor.name ]);
          })())();
      };
  };
  ...
  var drawGame = function (ctx) {
      return function (v) {
          return function __do() {
              ...
              drawLitGrid(20)(15)(32.0)(v.player.pos)(ctx)();
              return Player.draw(ctx)(v.player)();
          };
      };
  };
  var addGameEvent = function (ge) {
      return function (game) {
          var $48 = {};
          for (var $49 in game) {
              if ({}.hasOwnProperty.call(game, $49)) {
                  $48[$49] = game[$49];
              };
          };
          $48.eventQueue = new Data_List_Types.Cons(ge, game.eventQueue);
          return $48;
      };
  };
